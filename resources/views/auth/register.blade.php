                ...
                <div class="row g-0">
                  ...
                  <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                    <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                      ...
                      <p class="small mb-0">En mi página web personal, compartiré mi pasión, experiencias y conocimientos con ustedes.Gracias por visitar mi página web personal. ¡Espero que encuentren lo que buscan y disfruten su visita!</p>
                    </div>
                  </div>
                </div>
              </div>
